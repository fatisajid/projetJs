//1. Créez un tableau d'objets où chaque objet représente une ligne de dialogue avec le personnage et le texte.
...
//2. Ajoutez un écouteur d'événements au bouton "Lancer le dialogue" :
...
// let button = document.querySelector("#stratButton");
// let paragraphe  = document.querySelector("#welcomeText");
// let image = document.querySelectorAll("div > img");
// let dialogue = document.querySelector("#dialogueBox");
...
// 3.Créez une variable "currentIndex" pour suivre la ligne de dialogue actuelle.
// Créer une fonction qui permet de lire le tableau

// Logique de la fonction
// si mon index actuel et inferieur à la taille de mon tableau alors ...'
